...
import {
  Eye, EyeOff, Mail, Lock, ArrowLeft, User,
} from 'lucide-react';
    ...
    <div className="flex flex-col lg:flex-row w-full h-screen overflow-hidden bg-slate-50">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-2.5 px-10 pt-8">
          ...
          />
          <div className="text-black text-[10px] uppercase tracking-widest font-medium">Employee Portal</div>
        </div>
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-10 py-8 text-center gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 max-w-[260px] mx-auto leading-relaxed">
              Track attendance, manage tasks, view payslips, and stay connected with your team.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-2 px-10 pb-7">
          ...
          <span className="text-[11px] text-slate-400">Self-service portal &bull; Your data, your control</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[45%] h-screen overflow-y-auto flex items-center justify-center relative px-5 sm:px-10 py-10 bg-slate-50">
        ...
        {/* Corner decorations */}
        <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-emerald-50 to-transparent rounded-bl-full pointer-events-none" />
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          {/* Accent bar */}
          <div className="w-14 h-1 rounded-full bg-gradient-to-r from-blue-400 to-blue-500 mb-8" />
          ...
          <div className="mb-6">
            ...
            />
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 items-center justify-center hidden">
              <User className="w-5 h-5 text-white" />
            </div>
          </div>

          <h2 className="text-2xl font-bold text-slate-800 mb-1">Employee Portal</h2>
          <p className="text-sm text-slate-400 mb-8">Sign in to your personal workspace</p>
